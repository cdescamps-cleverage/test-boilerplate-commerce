...
## Environments
- Preview: https://main--test-boilerplate-commerce--cdescamps-cleverage.aem.page/
- Live: https://main--test-boilerplate-commerce--cdescamps-cleverage.aem.live/
...
1. Open the `test-boilerplate-commerce` directory in your favourite IDE and start coding :)
